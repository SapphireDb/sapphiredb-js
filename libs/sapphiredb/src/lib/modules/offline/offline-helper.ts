...
export class OfflineHelper {
  static getCommandIndexWithSameValue(filterFunction: (argument: unknown) => boolean, commands: CollectionCommandBase[]) {
    return commands.findIndex((command: CollectionCommandBase) => {
  ...
  static handleAddUpdateCommand(entry: UpdateEntry, collectionChanges: CollectionCommandBase[], commandIndex: number,
                                filterFunction: (argument: unknown) => boolean): boolean {
