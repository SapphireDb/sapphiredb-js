import {finalize, map, Observable, publishReplay, refCount} from 'rxjs';
...
export class Messaging {
  ...
  public publish(topic: string, data: any, retain?: boolean): void {
    this.connectionManagerService.sendCommand(new PublishCommand(topic, data, retain ?? false), false, true);
  }
}
